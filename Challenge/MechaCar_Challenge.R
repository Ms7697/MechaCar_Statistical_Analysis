...
# Import datasets
MechaCar_table <- read.csv(file = "/Users/salee/MechaCar_Statistical_Analysis/Challenge/MechaCar_mpg.csv", header = TRUE, sep = ",")
Suspension_table <- read.csv(file = "/Users/salee/MechaCar_Statistical_Analysis/Challenge/Suspension_Coil.csv", header = TRUE, sep = ",")
